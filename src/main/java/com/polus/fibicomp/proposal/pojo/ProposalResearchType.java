...
@Entity
@Table(name = "FIBI_SMU_PROPOSAL_RESRCH_TYPE")
public class ProposalResearchType implements Serializable {

	private static final long serialVersionUID = 1L;
	@Id
	@GenericGenerator(name = "proposalresearchTypeCodeGenerator", strategy = "increment", parameters = {
			@Parameter(name = "initial_value", value = "1"), @Parameter(name = "increment_size", value = "1") })
	@GeneratedValue(generator = "proposalresearchTypeCodeGenerator")
