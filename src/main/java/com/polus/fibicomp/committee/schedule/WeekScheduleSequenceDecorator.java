...
public class WeekScheduleSequenceDecorator extends ScheduleSequenceDecorator {
	 ...
	 * 
	 * @param frequency
	 *            can be weekly, biweekly, etc...
	 * @param dayCount
	 *            can be no of days in week meeting is scheduled.
	 */
	...
	public boolean equals(Object obj) {
		...
		return ObjectUtils.equals(dayCount, other.dayCount) && ObjectUtils.equals(frequency, other.frequency);
	}
}
